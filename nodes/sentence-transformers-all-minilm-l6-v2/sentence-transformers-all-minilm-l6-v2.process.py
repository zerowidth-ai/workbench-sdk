"""
Sentence Transformers: all-MiniLM-L6-v2 - Embedding node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Sentence Transformers: all-MiniLM-L6-v2 embedding node.
