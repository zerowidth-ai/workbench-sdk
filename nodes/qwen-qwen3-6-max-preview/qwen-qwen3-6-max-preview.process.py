"""
Qwen: Qwen3.6 Max Preview - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Qwen: Qwen3.6 Max Preview node.
