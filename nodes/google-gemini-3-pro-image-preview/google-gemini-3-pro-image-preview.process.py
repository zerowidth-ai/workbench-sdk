async def process({inputs, settings, config, nodeConfig}):
    ...
    try:
        ...
        raise Exception(f"Google: Nano Banana Pro (Gemini 3 Pro Image Preview) node error: {str(e)}")