"""
OpenAI: GPT Chat Latest - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the OpenAI: GPT Chat Latest node.
