"""
Google: Nano Banana 2 (Gemini 3.1 Flash Image Preview) - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Google: Nano Banana 2 (Gemini 3.1 Flash Image Preview) node.
