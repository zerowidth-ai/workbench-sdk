"""
Qwen: Qwen3 Next 80B A3B Instruct (free) - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Qwen: Qwen3 Next 80B A3B Instruct (free) node.
