async def process({inputs, settings, config, nodeConfig}):
    ...
    try:
        ...
        raise Exception(f"Qwen: Qwen3 Coder 480B A35B (free) node error: {str(e)}")