async def process({inputs, settings, config, nodeConfig}):
    """Process function for the Google: Gemini 2.5 Flash Image Preview (Nano Banana) node"""
    try:
        ...
        raise Exception(f"Google: Gemini 2.5 Flash Image Preview (Nano Banana) node error: {str(e)}")