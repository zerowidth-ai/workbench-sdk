"""
Sentence Transformers: multi-qa-mpnet-base-dot-v1 - Embedding node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Sentence Transformers: multi-qa-mpnet-base-dot-v1 embedding node.
