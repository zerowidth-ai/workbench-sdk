async def process({inputs, settings, config, nodeConfig}):
    """Process function for the OpenAI: GPT-5 Codex node"""
    try:
        ...
        raise Exception(f"OpenAI: GPT-5 Codex node error: {str(e)}")