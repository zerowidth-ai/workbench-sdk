"""
Perplexity: Sonar Pro Search - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Perplexity: Sonar Pro Search node.
