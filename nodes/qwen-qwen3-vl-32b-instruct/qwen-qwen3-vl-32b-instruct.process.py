"""
Qwen: Qwen3 VL 32B Instruct - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Qwen: Qwen3 VL 32B Instruct node.
    ...
    params = {}
    config_inputs = [{"name":"messages","display_name":"Conversation","type":"conversation or message or string","description":"Array of chat messages that make up the conversation","required":True},{"name":"system_prompt","display_name":"System Message","type":"message or string","description":"System prompt to instruct the model","default":None},{"name":"tools","display_name":"Tools","type":"tool or array of tools","description":"Array of tools to use","default":None,"allow_multiple":True},{"name":"tool_choice","display_name":"Tool Choice","type":"string","description":"Tool selection control","default":None},{"name":"response_format","display_name":"Response Format","type":"object","description":"Output format specification","default":None},{"name":"temperature","display_name":"Temperature","type":"number","description":"Controls randomness (0-2)","default":None},{"name":"top_p","display_name":"Top P","type":"number","description":"Controls diversity via nucleus sampling","default":None},{"name":"max_tokens","display_name":"Max Tokens","type":"number","description":"Maximum tokens to generate","default":None},{"name":"presence_penalty","display_name":"Presence Penalty","type":"number","description":"Encourages new topics (-2 to 2)","default":None},{"name":"seed","display_name":"Seed","type":"number","description":"Deterministic outputs","default":None}]
