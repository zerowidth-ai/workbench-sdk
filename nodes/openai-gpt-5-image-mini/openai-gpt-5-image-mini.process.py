"""
OpenAI: GPT-5 Image Mini - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the OpenAI: GPT-5 Image Mini node.
