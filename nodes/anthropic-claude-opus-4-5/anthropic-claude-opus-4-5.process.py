"""
Anthropic: Claude Opus 4.5 - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the Anthropic: Claude Opus 4.5 node.
