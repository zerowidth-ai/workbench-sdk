"""
NVIDIA: Llama Nemotron Embed VL 1B V2 (free) - Embedding node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the NVIDIA: Llama Nemotron Embed VL 1B V2 (free) embedding node.
