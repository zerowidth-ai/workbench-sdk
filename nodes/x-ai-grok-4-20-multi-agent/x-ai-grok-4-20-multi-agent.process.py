"""
xAI: Grok 4.20 Multi-Agent - LLM node for the zv1 engine.
"""
...
async def process(
    *,
    ...
    """
    Process function for the xAI: Grok 4.20 Multi-Agent node.
