...
public class HelpersTests
{
    ...
    {
        var result = Zv1Helpers.CreateSafeToolName(input);
    ...
    {
        var result = Zv1Helpers.IsRemoteMcpTool(path);
        Assert.Equal(expected, result);
    }
    ...
    {
        var result = Zv1Helpers.MapTypeToJsonSchema(inputType);
    ...
    {
        var result = Zv1Helpers.ExtractTextFromContent(content);
        Assert.Equal(expected, result);
    }
    ...
    {
        var single = "item";
        var result = Zv1Helpers.EnsureList(single);
    ...
    public void EnsureList_ReturnsListAsIs()
    {
        ...
        var result = Zv1Helpers.EnsureList(list);
    ...
    {
        var result = Zv1Helpers.EnsureList(null);
        Assert.Empty(result);
    }
    ...
    public void DeepMerge_MergesDictionaries()
    {
        ...
        var result = Zv1Helpers.DeepMerge(target, source);
