...
public record ErrorEvent
{
    ...
    public required WorkbenchEngineException Error { get; init; }
...
public class ErrorManager
{
    ...
    public ErrorEvent RecordError(WorkbenchEngineException error)
    {
    ...
    {
        WorkbenchEngineException zv1Error = exception switch
        {
            WorkbenchEngineException zv1Ex => zv1Ex,
    ...
    private void LogError(WorkbenchEngineException error)
    {
