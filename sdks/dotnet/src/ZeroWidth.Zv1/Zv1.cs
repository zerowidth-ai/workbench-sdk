...
/// <summary>
/// Configuration options for the Zv1 engine.
/// </summary>
public class Zv1Options
{
...
/// </summary>
public class Zv1 : IAsyncDisposable
{
    private readonly Zv1Options _options;
    ...
    /// <summary>
    /// Initializes a new instance of the Zv1 class.
    /// </summary>
    /// <param name="options">Engine configuration options.</param>
    public Zv1(Zv1Options? options = null)
    {
        _options = options ?? new Zv1Options();
    ...
    /// <summary>
    /// Creates and initializes a new Zv1 engine instance.
    /// </summary>
    /// <param name="options">Engine configuration options.</param>
    /// <returns>An initialized Zv1 engine.</returns>
    public static async Task<Zv1> CreateAsync(Zv1Options options)
    {
        var engine = new Zv1(options);
    ...
    public async Task InitializeAsync()
    {
        ...
        // Load nodes
        _nodes = await Zv1Loaders.LoadNodesAsync(nodesDir);
        ...
        {
            _flow = await Zv1Loaders.DetectAndLoadFlowAsync(_options.Flow);
        }
        ...
        if (_options.Keys != null)
        {
            ...
            Zv1Validators.ValidateKeys(nodeConfigs, _options.Keys);
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var nodeConfigs = _nodes.ToDictionary(
                kvp => kvp.Key,
                kvp => kvp.Value.Config);
            var (inputNodes, entryNodes) = Zv1Validators.ValidateFlow(_flow, nodeConfigs);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            // Validate inputs
            Zv1Validators.ValidateInputs(nodeDef.Config, inputs, _customTypes);
            ...
            // Validate outputs
            Zv1Validators.ValidateOutputs(nodeDef.Config, outputs, _customTypes);
