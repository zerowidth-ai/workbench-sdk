...
namespace ZeroWidth.Zv1.Loaders;
...
/// </summary>
public static class Zv1Loaders
{
    /// <summary>
    ...
    public static async Task<JsonElement> DetectAndLoadFlowAsync(object source)
    {
        ...
        if (source is string str)
        {
            ...
            if (File.Exists(str))
            {
                ...
                {
                    return await LoadZv1FileAsync(str);
                }
                else
                {
        ...
        {
            return await LoadZv1FromBytesAsync(bytes);
        }

        if (source is Stream stream)
        {
            return await LoadZv1FromStreamAsync(stream);
        }
    ...
    public static async Task<JsonElement> LoadZv1FileAsync(string path)
    {
    ...
    /// <returns>The parsed flow.</returns>
    public static async Task<JsonElement> LoadZv1FromBytesAsync(byte[] bytes)
    {
    ...
    /// <returns>The parsed flow.</returns>
    public static async Task<JsonElement> LoadZv1FromStreamAsync(Stream stream)
    {
    ...
    {
        var assembly = typeof(Zv1Loaders).Assembly;
